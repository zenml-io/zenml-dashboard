...
export const matchSegmentWithTab = (segment: string) => {
	const routeMap: { [key: string]: JSX.Element } = {
		overview: <Icon name="info" className="h-5 w-5 fill-theme-text-tertiary" />,
		configuration: <Icon name="tool-02" className="h-5 w-5 fill-theme-text-tertiary" />
	};

	return routeMap[segment] || <Icon name="info" className="h-5 w-5 fill-theme-text-tertiary" />;
};
