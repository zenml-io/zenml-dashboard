...
function AnnouncementEmptyState({ title, subtitle }: Props) {
	return (
		<div className="p-5">
...
export function NoAnnouncementEmptyState() {
	return (
		<AnnouncementEmptyState
			title="No Announcements"
			subtitle="There are no announcements to display."
		/>
	);
}

export function AnnouncementErrorState() {
	return (
		<AnnouncementEmptyState
