...
const type: StackComponentType = "artifact_store";

export function ArtifactStoreListForm() {
	const [filter, setFilter] = useState("");
	const { control, setValue, handleSubmit, register, watch, trigger, reset } =
		useFormContext<ArtifactStoreForm>();

	const { flattenedInstances, handleFormSubmit } = useArtifactStore();
							...
							<Controller
								...
								render={({ field: { onChange, ...restField } }) => (
									...
									>
										...
										/>
										<FlavorIcon type={type} width={24} height={24} flavor={instance.flavor} />{" "}
