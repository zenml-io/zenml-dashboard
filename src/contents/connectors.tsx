...
export const KubernetesSection: ConnectorTypeSectionProps = {
	help: {
		href: "https://docs.zenml.io/how-to/infrastructure-deployment/auth-management/kubernetes-service-connector",
...
export const GCPSection: ConnectorTypeSectionProps = {
	help: {
		...
		href: "https://docs.zenml.io/how-to/infrastructure-deployment/auth-management/gcp-service-connector"
	},
...
export const DockerSection: ConnectorTypeSectionProps = {
	help: {
		...
		href: "https://docs.zenml.io/how-to/infrastructure-deployment/auth-management/docker-service-connector"
	},
...
export const AzureSection: ConnectorTypeSectionProps = {
	help: {
		...
		href: "https://docs.zenml.io/how-to/infrastructure-deployment/auth-management/azure-service-connector"
	},
...
export const AWSSection: ConnectorTypeSectionProps = {
	help: {
		...
		href: "https://docs.zenml.io/how-to/infrastructure-deployment/auth-management/aws-service-connector"
	},
